...
public class TeTestDriver extends AbstractTestDriver {
    ...
    public TestTask createTestTask(final TestTaskDto testTaskDto) throws TestTaskInitializationException {
        try {
            ...
            return new TeTestTask(
                    ...
                    credentials, (TeTypeLoader) this.loader, testTaskDto);
        } catch (IncompleteDtoException | InvalidPropertyException e) {
    ...
    final public void doInit()
        ...
        final String teUrl = configProperties.getPropertyOrDefault(TE_REMOTE_URL, TE_REMOTE_DEFAULT_URL);
        ...
        this.loader = new TeTypeLoader(dataStorageCallback, apiUri, credentials, this.getInfo());
        this.loader.getConfigurationProperties().setPropertiesFrom(configProperties, true);
    }
